			...
			<div class="cont-space">
				...
				<div class="board-write">
					<form method="POST" name="signForm" enctype="multipart/form-data">
						...
						<input type="hidden" name="sign_file_path" value="${sign.sign_file_path}"/>
						<div class="sign-image">
							<div class="image-field">
								<img id="sign_file" src="${sign.sign_file_path}">
					...
					<div class="btn">
						...
						<a href="javascript:void(0)" onclick="signSubmit();" class="submit">수정</a>
					</div>
				</div>
			</div>
		</div>
...
<script>
	function signSubmit(){
		...
		form.action = "/auth/mypage/sign/modify/process";
		form.submit();
	}
</script>
<script>
