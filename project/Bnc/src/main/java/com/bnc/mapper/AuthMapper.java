...
public interface AuthMapper {
	...
	public int selectMember(String memb_id); 						// 회원계정 조회
	...
	public int modifyCompanyInfo(CompanyVO company); 				// 기업정보 수정
	...
	public int modifySign(SignVO sign); 							// 서명 수정
	
	public int deleteSign(int sign_num); 							// 서명 삭제
	
	
	/*이용약관*/
	public TermsVO read(String pol_kind);							// 약관 보기
		
	public int memberCount();										// 회원 숫자 카운트
}
